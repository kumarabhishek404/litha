  ...
  return (
    ...
    >
      {itemList.map((item, index) => {
        // console.log(router.pathname, item.path, "path");
        return (
          <React.Fragment key={index}>
            <ListItem
              className={`d-flex justify-content-between side_nav_item ${router.pathname == `/admin${item.path}` ? 'active' : ''}`}
              button
              onClick={() => handleClick(item.title, item)}>
              <span
                className="d-flex sidebar nav__link"
                style={{ color: theme.textColor }}>
                <ListItemIcon style={{ color: router.pathname === `/admin${item.path}` ? "#fff" : theme.textColor }}>
                  {item.icon}
                </ListItemIcon>
                  ...
                  <List component="div" disablePadding>
                    <NavLink style={{ color: theme.textColor }} className="d-flex sidebar nav__link" to={{ pathname: childItem.path }}>
                      <ListItem button className={classes.nested}>
                        <ListItemIcon
                          style={{ color: router.pathname === `/admin${item.path}` ? "#fff" : theme.iconColor }}>
                          {childItem.icon}
                        </ListItemIcon>
