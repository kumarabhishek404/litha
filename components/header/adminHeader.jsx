...
import { logoutAdminApi } from '../../services/auth.service';
...
const Headers = (props) => {
  ...
  return (
    <>
      <div className={`grow main-header ${mobileView ? "mobile" : "desktop"}`}>
        {!mobileView ?
          (<AppBar
            style={{
