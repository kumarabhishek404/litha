...
const PTSD5 = ({ imageSrc, heading, subHeading }) => {
    const [lang] = useLang();
    ...
    return (
        <Layout>
            ...
            <Chatbot
                ...
                userId={userId}
                sessionId={sessionId}
                botURLwithSender={`https://ptsd5-bot.litha.org.uk/conversations/${botName}_${userId}_${sessionId}/execute`}
                botServerURL="https://ptsd5-action.litha.org.uk/webhook/"
                botURL="https://ptsd5-bot.litha.org.uk/webhooks/rest/webhook" />
        </Layout>
    )
}
