...
const GAD7 = ({ imageSrc, heading, subHeading }) => {
    const [lang] = useLang();
    ...
    return (
        <Layout>
            ...
            <Chatbot
                ...
                userId={userId}
                sessionId={sessionId}
                botURLwithSender={`https://gad7-bot.litha.org.uk/conversations/${botName}_${userId}_${sessionId}/execute`}
                botServerURL = "https://gad7-action.litha.org.uk/webhook/"
                botURL="https://gad7-bot.litha.org.uk/webhooks/rest/webhook" />
        </Layout>
    )
}
