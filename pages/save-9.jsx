...
const SAVE9 = ({ imageSrc, heading, subHeading }) => {
    const [lang] = useLang();
    ...
    return (
        <Layout>
            ...
            <Chatbot
                ...
                userId={userId}
                sessionId={sessionId}
                botURLwithSender={`https://save9-bot.litha.org.uk/conversations/${botName}_${userId}_${sessionId}/execute`}
                botServerURL="https://save9-action.litha.org.uk/webhook/"
                botURL="https://save9-bot.litha.org.uk/webhooks/rest/webhook" />
        </Layout>
    )
}
