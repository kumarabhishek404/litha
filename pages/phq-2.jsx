...
const PHQ2 = ({ imageSrc, heading, subHeading }) => {
    const [lang] = useLang();
    ...
    return (
        <Layout>
            ...
            <Chatbot
                ...
                userId={userId}
                sessionId={sessionId}
                botURLwithSender={`https://phq2-bot.litha.org.uk/conversations/${botName}_${userId}_${sessionId}/execute`}
                botServerURL = "https://phq2-action.litha.org.uk/webhook/"
                botURL="https://phq2-bot.litha.org.uk/webhooks/rest/webhook"
                botMsg1={text.PhqBotMsg1}
                botMsg2={text.PhqBotMsg2} />
        </Layout>
    )
}
