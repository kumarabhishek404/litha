...
const GAD2 = ({ imageSrc, heading, subHeading }) => {
    const [lang] = useLang();
    ...
    return (
        <Layout>
            ...
            <Chatbot
                name='GAD-2'
                botImage="https://imgur.com/bH2qSju.png"
                botName={botName}
                portName="5032"
                userId={userId}
                sessionId={sessionId}
                botURLwithSender={`https://gad2-bot.litha.org.uk/conversations/${botName}_${userId}_${sessionId}/execute`}
                botServerURL = "https://gad2-action.litha.org.uk/webhook/"
                botURL="https://gad2-bot.litha.org.uk/webhooks/rest/webhook" />
        </Layout>
    )
}
